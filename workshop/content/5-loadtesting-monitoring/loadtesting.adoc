...
image::../imgs/module-5/quay_io_native_image_build_gb_action.gif[Github Action to build native images for our applications]
...
[source, shell, role=copy]
----
kn service update quarkus-app --image quay.io/redhat_na_ssa/quarkus-app-native
----
...
[source, shell, role=copy]
----
kn service update micronaut-app --image quay.io/redhat_na_ssa/micronaut-app-native
----
...
[source, shell, role=copy]
----
kn service update springboot-app --image quay.io/redhat_na_ssa/springboot-app-native
----