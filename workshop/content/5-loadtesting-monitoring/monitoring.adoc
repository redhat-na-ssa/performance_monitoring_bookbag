...
----
+
2. go to OpenShift Console Developer perspective, switch to the `{user}-cicd` and open the link:{openshift_console_url}/dev-pipelines/ns/{user}-cicd[*Pipelines* view] from the left Menu.
+
[IMPORTANT]
====
